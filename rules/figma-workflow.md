...
3. Organize into structured tables (Layout / Colors / Typography / Borders & Effects)
4. When encountering TEXT nodes, check whether the text might have character-level fills (based on design intent)
5. For areas suspected to have multi-color text, download screenshots using `download_figma_images` as reference
